...
function ValueSection() {
  return (
    ...
    >
      ...
      >
        I am not just a developer – I have built and shipped entire SaaS
        products from zero to paying users. I understand engineering, UX,
        business constraints, and real-world reliability.
      </motion.p>

      {/* Cards – each one is its own stagger item */}
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <ValueCard
          ...
          description="Background schedulers, payments, SMS, and webhooks designed for fault tolerance."
        />
        <ValueCard
          icon="lucide:message-square"
          title="Clear Communication"
          description="No blockers, no ambiguity. I keep features moving forward with constant clarity."
        />
        <ValueCard
          icon="lucide:zap"
          title="AI-Enhanced Development"
          description="I use AI-assisted workflows and deep engineering knowledge to move fast while keeping systems stable and correct."
        />
      </div>
    </MotionSection>
  );
