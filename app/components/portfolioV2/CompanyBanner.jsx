...
const companies = [
  ...
  {
    name: "2351 Labs",
    logo: null, // Will render as text logo
    rounded: false,
  },
];
          ...
          >
            <div className="relative">
              {company.logo ? (
                ...
                <div
                  className={`w-12 h-12 bg-linear-to-br from-slate-900 to-slate-800 border border-slate-600 flex flex-col items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:from-slate-800 group-hover:to-slate-700 group-hover:border-slate-500 relative overflow-hidden ${
                    company.rounded ? "rounded-full" : "rounded-md"
                  }`}
                >
